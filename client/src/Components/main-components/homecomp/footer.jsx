import { Twitter, Facebook, Instagram, Linkedin, ShieldCheck } from "lucide-react";

export default function Footer() {
  return (
    <footer className="bg-white text-slate-800 py-6 border-t border-slate-200  w-full top-0 z-50 px-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="font-semibold text-sm text-slate-900 tracking-wide">Guardian Earth</span>
            </div>
            <p className="text-sm text-slate-600 mb-4 text-left">Advanced disaster management solutions for a safer world.</p>
          ...
          <div className="lg:ml-10">
            <h4 className="font-medium text-sm text-slate-900 mb-4 lg:text-left ">Solutions</h4>
            <ul className="space-y-2 text-xs text-slate-700 lg:text-left">
              ...
              <li>
                <a href="/solutions/earthquake" className="hover:text-green-500">
          ...
          {/* Company */}
          <div className="lg:ml-10">
            <h4 className="font-medium text-sm text-slate-900 mb-4 lg:text-left">Company</h4>
            <ul className="space-y-2 text-xs text-slate-700 lg:text-left">
              <li>
          ...
          {/* Resources */}
          <div className="lg:ml-10">
            <h4 className="font-medium text-sm text-slate-900 mb-4 lg:text-left">Resources</h4>
            <ul className="space-y-2 text-xs text-slate-700 lg:text-left">
              <li>
        ...
        <div className="border-t border-slate-200 mt-10 pt-4 text-xs flex flex-col md:flex-row justify-between items-center text-slate-500">
          <p className="mb-2 md:mb-0">© 2025 Guardian Earth. All rights reserved.</p>
